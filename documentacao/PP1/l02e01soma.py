...
- Operador aritmético:
    ...
    *   →   multiplicação
    /   →   divisão
    //  →   quociente da divisão de inteiros
...
3- Como rodar (executar) o programa:
   - Seta na parte superior ou Run - Run ou use as teclas de atalho.
...
Teste 1: Entrada: Primeiro valor: 10            Saída: soma igual a 30
                  Segundo valor: 20
Fim do Comentário de várias linhas.
"""
# Recebe os valores convertidos para número inteiro (entrada de dados)
